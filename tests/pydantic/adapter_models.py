...
from mongospecs.pydantic import SubSpec
...
class ComplexDragon(Dragon):
    ...
    # SerializeAsAny is needed:
    #  * https://github.com/pydantic/pydantic/issues/7326
    #  * https://github.com/pydantic/pydantic/issues/6423
    #  * https://github.com/pydantic/pydantic/issues/6632
    lair: SerializeAsAny[Lair] = Field(default_factory=Lair)
