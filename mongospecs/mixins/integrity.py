...
class IntegrityMixin(MongoBaseMixin):
    @classmethod
    def cascade(cls, ref_cls: "type[MongoBaseMixin]", field: str, specs: t.Sequence[t.Self]) -> None:
    ...
    @classmethod
    def nullify(cls, ref_cls: "type[MongoBaseMixin]", field: str, specs: t.Sequence[t.Self]) -> None:
    ...
    @classmethod
    def pull(cls, ref_cls: "type[MongoBaseMixin]", field: str, specs: t.Sequence[t.Self]) -> None:
